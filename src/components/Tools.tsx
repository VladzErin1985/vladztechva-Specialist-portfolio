...
type ToolIcon =
  ...
  | { type: "custom"; component: React.ComponentType<{ size?: number; color?: string }>; color: string };

// Custom mark for Momentum AMS — three ascending slanted bars, matching their brand icon
const MomentumMark = ({ size = 28, color = "#4361EE" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="3" y="13" width="4" height="8" rx="2" transform="rotate(-18 5 17)" fill={color} />
    <rect x="9.5" y="7" width="4" height="14" rx="2" transform="rotate(-18 11.5 14)" fill={color} />
    <rect x="16" y="1" width="4" height="20" rx="2" transform="rotate(-18 18 11)" fill={color} />
  </svg>
);
...
const tools: Tool[] = [
  ...
  { name: "Momentum AMS", icon: { type: "custom", component: MomentumMark, color: "#4361EE" }, category: "CRM", color: "#4361EE" },
